            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Profil</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a class="nav-link scrollto active" <?php echo base_url('User/sejarah') ?>">Tentang KTTH</a></li>
    ...
    <main id="main">
      ...
      <section id="features" class="features">
        <div class="container" data-aos="fade-up">
          ...
          <?php  foreach ($misi as $vm):?> 
           <div class="row">
          <div class="col-lg-12 order-2 order-lg-1 d-flex flex-column align-items-lg-justify">
            <div class="icon-box mt-5 mt-lg-0" data-aos="fade-up" data-aos-delay="100">
              <i>*</i>
              <p><?php echo $vm->isi_misi; ?></p>
            </div>
            </div>
            <?php endforeach; ?>
        ...
        <section id="services" class="services section-bg">
          <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
              ...
              <p class="align-items-lg-justify">Organisasi berasal dari kata Organon dalam bahasa Yunani yang berarti alat. Definisi organisasi telah banyak dikemukakan oleh para ahli baik dari dalam maupun luar negeri. Secara garis besar pengertian dan definisi organisasi adalah suatu kelompok terdiri atas dua atau lebih orang yang saling bekerja sama untuk mencapai tujuan tertentu secara bersama. Dalam Kamus Besar Bahasa Indonesia (KBBI), organisasi adalah suatu kesatuan atau susunan yang terdiri atas orang-orang dalam perkumpulan untuk mencapai tujuan bersama. Contohnya seperti sekelompok orang yang bekerja sama, layaknya asosiasi lingkungan, amal, serikat pekerja, atau perusahaan</p>
            </div>
                ...
                <div class="row">
                  <?php  foreach ($sejarah as $s):?>   
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="150">
                      <img src="<?= base_url('assets/images/').$s->gambar_sejarah ?>" class="img-fluid" alt=""/>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
                      <br>

                      <h3><?php echo $s->judul_sejarah; ?></h3>
                      <ul>
                        <p><?php echo $s->isi_sejarah; ?></p>
                      </ul>
