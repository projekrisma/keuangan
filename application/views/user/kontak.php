        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="<?php echo base_url('user/kontak') ?>">Kontak</a></li>
        ...
        <section id="contact" class="contact section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Kontak</h2>
                    <p>Hubungi kami melalui media sosial resmi KTTH Simpang Tolang Lama. Jika Anda ingin menanyakan tentang informasi seputar KTTH.
                    </p>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="info-box mb-4">
                            <i class="bx bx-map"></i>
                            <h3>Alamat</h3>
                            <p>Jorong Simpang Tolang, Kec. Ranah Batahan, Kab. Pasaman Barat, Prov. Sumatera Barat.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="info-box  mb-4">
                            ...
                            <h3>Email</h3>
                            <p>Simpangtolanglama@gmail.com</p>
                        </div>
                    </div>
