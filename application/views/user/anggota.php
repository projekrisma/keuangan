                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Profil</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            ...
                            <li class="active"><a  href="<?php echo base_url('User/anggota') ?>">Anggota KTTH</a></li>
        ...
        <section id="pricing" class="pricing section-bg">
          <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
              <h2>ANGGOTA ORGANISASI</h2>
              <p>Anggota Organisasi adalah pemuda/pemudi yang bedomisili dan beralamat di jorong simpang tolang. Untuk Anggota Organisasi yang sudah memiliki akun silahkan login untuk informasi keuangan organisasi selegkapnya.</p>
          </div>
