            ...
            <?php  foreach ($data as $s):?>
                <div class="row">
                  ...
                  <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="150">
                      <img src="<?= base_url('assets/foto_user/').$s->foto ?>" class="img-fluid" alt=""/>
                  </div>
                  <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
                    ...
                    <ul>
                      <li><i class="bi bi-check-circle"></i> Nama          = <?php echo $s->nama_lengkap; ?></li>
                      <li><i class="bi bi-check-circle"></i> Jenis Kelamin = <?php echo $s->jk; ?></li>
                      <li><i class="bi bi-check-circle"></i> Alamat        = <?php echo $s->alamat; ?></li>
                      <li><i class="bi bi-check-circle"></i> Nomor Hp      = <?php echo $s->no_telp; ?></li>
                      <li><i class="bi bi-check-circle"></i> Jabatan       = <?php echo $s->jabatan; ?></li>
                  </ul>
