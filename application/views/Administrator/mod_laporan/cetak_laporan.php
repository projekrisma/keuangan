...
<body onload="window.print()">
  <div class="col-xs-12">
    <div style="text-align:justify; margin-top: 20px">
      <img src="<?php echo base_url(); ?>assets/images/logo.png" style="width: 78px; height: 80px; float:left; margin:0 8px 4px 0;" />
      <p style="text-align: center; line-height: 20px">
        <span style="font-size: 15px">KARANG TARUNA TUNAS HARAPAN (KTTH)</span><br />
        <span style="font-size: 20px;"><strong>JORONG SIMPANG TOLANG LAMA</strong></span><br />
        <span style="font-size: 12px">Jln. Raya Sukowati No. 534 Telp. (271) 891068 Sragen 57272</span><br />
        <span style="font-size: 12px">Website : www.ktthsimpangtolang.go.org dan Email : simpangtolanglama@gmail.com</span>
      </p>
    </div>
