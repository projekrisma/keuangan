<div class="row clearfix">
  ...
  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <div class="info-box-3 bg-dark hover-zoom-effect">
      <div class="content">
        <h4>DATA KEUANGAN : <a href="<?php echo base_url('administrator/keuangan') ?>" class="small-box-footer">Klik Disini</a></h4>
      </div>
    </div>
  </div><!-- ./col -->
  ...
  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <div class="info-box-3 bg-dark hover-zoom-effect">
      <div class="content">
        <h4>LAPORAN KEUANGAN : <a href="<?php echo base_url('administrator/laporanuser') ?>" class="small-box-footer">Klik Disini</a></h4>
      </div>
    </div>
  </div><!-- ./col -->
</div><!-- /.row -->
